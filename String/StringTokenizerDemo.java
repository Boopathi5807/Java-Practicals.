...
public class StringTokenizerDemo {
	...
	public static void main(String[] args) {
		System.out.println("******************************************");
		StringTokenizer sb = new StringTokenizer("hello world i am Boopathi", " ");
		System.out.println(sb.hasMoreTokens());
		while (sb.hasMoreTokens()) {
			System.out.println(sb.nextToken());
		}
		System.out.println("*******************************************");
		StringTokenizer sb1 = new StringTokenizer("hello;world;i;am;Boopathi", ";");
		...
		System.out.println("********************************************");
		// delimiter flag
		StringTokenizer sb2 = new StringTokenizer("hello world i am Boopathi", " ", true);
