...
public class StudentDatabaseProject {
	...
	public static class StudentManagementSystem {
		...
		public static void addStudent(int sId, String sName, String sAddress) throws ClassNotFoundException, SQLException
		{
		...
		public static void updateStudent(int sId, String sName, String sAddress)throws SQLException, ClassNotFoundException 
		{
			Class.forName("com.mysql.cj.jdbc.Driver");
			Connection con = DriverManager.getConnection("jdbc:mysql:///school", "root", "12345");
