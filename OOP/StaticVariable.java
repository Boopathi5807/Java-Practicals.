...

{
	...
	{
		this.id = id; // (this) keyword used to assigning the local Variable and Instance Variable is
						// same.
		this.Name = Name;
...

	{
		...
		StaticVariable sb = new StaticVariable(77, "Boopathi");

		sb.Display();// calling Display Method

		StaticVariable sb1 = new StaticVariable(78, "Aashik");

		sb1.Display();

		StaticVariable sb2 = new StaticVariable(79, "Aashvin");
